    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-lg transition-colors flex items-center gap-1 disabled:opacity-50 disaled:cursor-not-allowed text-white"
        >
          {isUploading ? (
