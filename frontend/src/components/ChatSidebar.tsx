        ...
        <div className="flex items-center justify-between">
          <div className="flex item-center gap-3">
            ...
            <h2 className="text-xl font-bold text-white">
              {shopwAllUsers ? "New Chat" : "Messages"}
            </h2>
          </div>
          <button
            onClick={() => setShowAllUsers((prev) => !prev)}
            className={`p-2.5 rounded-lg transition-colors ${shopwAllUsers ? "bg-red-600 hover:bg-red-700 text-white" : "bg-green-600 hover:bg-green-700 text-white"}`}
          >
            {shopwAllUsers ? (
              <X className="w-4 h-4" />
            ) : (
        ...
        {shopwAllUsers ? (
          <div className="space-y-4 h-full">
            <div className="relative">
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 trxt-gray-400" />
              <input
                type="text"
